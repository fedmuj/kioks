...
const POINT_OF_SALE = 'sse4eu.com';
const CURRENCY = 'EUR';
...
export function identifyVisitor(
  ...
  let identity, email_aux;
  if (email === '4321') {
    identity = 'Demo Customer 7';
    email_aux = 'fmf.sitecore+eurobankdemo7@gmail.com';
  }
  if (email === '1234') {
    identity = 'Demo Customer 3';
    email_aux = 'fmf.sitecore+eurobankdemo3@gmail.com';
  }
  if (email === '9999') {
    identity = 'Demo Customer 6';
    email_aux = 'fmf.sitecore+eurobankdemo5@gmail.com';
  }
